...
> If you use CryptoAuthentication in your nodes, do not forget to  [**“personalize” all the nodes with encryption key**](https://github.com/EasySensors/ButtonSizeNode/blob/master/SecurityPersonalizationHowTo.md) then.
